...
export default function Page() {
  ...
  <main>
    ...
    {/* Why Choose Us */}
    <div className="why-choose-us bg-transparent mt-100 section-padding">
      ...
      <div className="container">
            ...
            <div className="col-12 col-lg-6">
              <div className="choose-us-content section-headings">
                ...
                <div className="choose-logo">
                  <div className="choose-rotating-logo svg-wrapper" data-aos="zoom-in-up">
                    <svg className="infinite-rotate" viewBox="0 0 179 179" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-abs">25</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="choose-bottom">
          <div className="choose-bottom-cards">
            <div className="row">
              <div className="col-12 col-lg-6 col-xl-4" data-aos="fade-up">
                <div className="card-icon-text card-icon-text-horizontal">
                  ...
                  <div className="content">
                    <h2 className="heading text-20 fw-700">Our Mission</h2>
              ...
              <div className="col-12 col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="100">
                <div className="card-icon-text card-icon-text-horizontal">
                  <div className="svg-wrapper">
                    <svg viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="70" height="70" rx="10" fill="white" />
                  ...
                  <div className="content">
                    <h2 className="heading text-20 fw-700">Our Vision</h2>
                    <p className="text text-16">
                      Our mission is push engage boundaries, enga audiences,
                      and driv engage.
                    </p>
              ...
              <div className="col-12 col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                <div className="card-icon-text card-icon-text-horizontal">
                  <div className="svg-wrapper">
                    <svg viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="70" height="70" rx="10" fill="white" />
                  ...
                  <div className="content">
                    <h2 className="heading text-20 fw-700">Our Awards</h2>
                    <p className="text text-16">
                      Our mission is push engage boundaries, enga audiences,
                      and driv engage.
                    </p>
          ...
          <div className="choose-media-absolute radius18" data-aos="fade-up" data-aos-delay="400">
    ...
    {/* Our Team */}
    <team-slider className="team-slider mt-100">
      <div className="container">
                ...
                <div className="card-team radius18">
                  ...
                  <div className="card-team-content-absolute">
                    <div className="card-team-content">
                      <Link href="team-details.html" aria-label="team details" className="heading text-22 fw-600">Ronald
                        Richards</Link>
                      <p className="text text-18">Finance Advisor</p>
                    </div>
                  </div>
                  <div className="social-list">
                    <Link href="#" className="svg-wrapper" aria-label="LinkedIn">
                      <svg className="icon icon-20" xmlns="http://www.w3.org/2000/svg" width="17" height="16"
                    ...
                    <Link href="#" className="svg-wrapper" aria-label="twitter">
                      <svg className="icon icon-20" xmlns="http://www.w3.org/2000/svg" width="18" height="14"
                    ...
                    <Link href="#" className="svg-wrapper" aria-label="instagram">
    ...
    {/* Testimonial */}
    <div className="testimonial mt-100 section-padding">
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-7 col-12">
            <div className="testimonial-card-inner">
              <div className="card-testimonial radius18" data-aos="fade-up" data-aos-delay="10">
                ...
                <p className="text text-24">“ Working with several word themes and templates the last years only can say
                ...
                <div className="user-info-wrap">
                  <div className="user-info">
                    ...
                    <div className="user-name-desig">
                      <h2 className="user-name heading text-24">Marvin Kinney</h2>
                      <div className="user-desig text text-18">Product Manager</div>
                    </div>
                  </div>
              ...
              <div className="card-testimonial radius18" data-aos="fade-up" data-aos-delay="150">
                ...
                <div className="user-info-wrap">
                  <div className="user-info">
                    ...
                    <div className="user-name-desig">
                      <h2 className="user-name heading text-24">Charlize Theron</h2>
                      <div className="user-desig text text-18">Product Manager</div>
                    </div>
                  </div>
                  <div className="icon-quote">
        ...
        <div className="row faq-row">
          <div className="col-lg-6 col-12">
            <div className="section-headings">
              ...
              <div className="text text-18" data-aos="fade-up" data-aos-delay="80">
              ...
              <div className="buttons" data-aos="fade-up" data-aos-delay="100">
                <Link href="about.html" className="button button--primary" aria-label="Ask Your Question">
                  Ask Your Question
                  <span className="svg-wrapper">
                    <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-lg-6 col-12">
            <faq-accordion>
              <div className="accordion-list">
                <div className="accordion-block" data-aos="fade-up">
                  <div className="accordion-opener heading text-22">
                ...
                <div className="accordion-block" data-aos="fade-up" data-aos-delay="50">
                  <div className="accordion-opener heading text-22">
                ...
                <div className="accordion-block" data-aos="fade-up" data-aos-delay="100">
                  <div className="accordion-opener heading text-22">
                ...
                <div className="accordion-block" data-aos="fade-up" data-aos-delay="150">
                  <div className="accordion-opener heading text-22">
                ...
                <div className="accordion-block" data-aos="fade-up" data-aos-delay="200">
                  <div className="accordion-opener heading text-22">
