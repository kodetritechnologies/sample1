...
export default function Page() {
  ...
  <main>
    {/* Hero Banner */}
    <div className="hero-slider hero-slider-3 with-floating-header with-fixed-bg">
      <div className="slider-card overlay">
        <picture className="slider-media">
          <source media="(max-width: 575px)" srcSet="assets/img/slider/b-575.jpg" />
          <source media="(max-width: 991px)" srcSet="assets/img/slider/b-991.jpg" />
          <img src="assets/img/slider/b1.jpg" width="1920" height="1000" loading="eager" alt="Hero Image" />
        </picture>
          ...
          <div className="container height-100 d-flex align-items-center justify-content-center text-center">
            <div className="content-box section-headings">
              <div className="subheading text-20 subheading-bg" data-aos="fade-up">
                <svg className="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                  fill="none">
                ...
                <span>welcome to Your Logo</span>
                <svg className="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                  fill="none">
                  <g clip-path="url(#clip0_9088_4143)">
                    <path
              ...
              <h2 className="heading text-90 fw-700" data-aos="fade-up" data-aos-delay="100">
                Business Growth Made Simple
              </h2>
              <div className="text text-18" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="buttons" data-aos="fade-up" data-aos-delay="300">
                <Link href="contact.html" className="button button--secondary" aria-label="hero button">
                  Free Consultation
    ...
    {/* Brand Logo */}
    <div className="running-content mt-100">
      <div className="content-inner">
        <div className="content-lists running-animation">
          <div className="content-item">
            <Link href="about.html" className="content-link">
          ...
          <div className="col-lg-6 col-12">
            <div className="content section-headings">
              ...
              <ul className="text-lists list-unstyled">
                <li className="text-item text text-18" data-aos="fade-up">
              ...
              <div className="buttons" data-aos="fade-up">
                <Link href="about.html" className="button button--primary" aria-label="More About Us">
                  More About Us
                  <span className="svg-wrapper">
                    <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="multicolumn multicolumn-page section-padding">
      <div className="container">
          ...
          <div className="row product-grid">
            <div className="col-xl-4 col-md-6 col-12" data-aos="fade-up">
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                ...
                <h2 className="heading text-28">Business Consulting</h2>
                <div className="text text-16">
                  See how our tailored solutions can boost your business. From
                  planning to support.
                </div>
                <ul className="text-lists list-unstyled">
                  <li className="text-item text text-16 fw-500">
            ...
            <div className="col-xl-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="200">
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                ...
                <h2 className="heading text-28">Plan development</h2>
                <div className="text text-16">
                  See how our tailored solutions can boost your business. From
                  planning to support.
                </div>
            ...
            <div className="col-xl-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="300">
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                ...
                <h2 className="heading text-28">Finance strategy</h2>
                <div className="text text-16">
                  See how our tailored solutions can boost your business. From
                  planning to support.
                </div>
            ...
            <div className="col-xl-4 col-md-6 col-12" data-aos="fade-up">
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                <div className="card-icon">
                  <svg className="icon-40" width="40" height="40" viewBox="0 0 40 40" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 className="heading text-28">Investment Idea</h2>
                <div className="text text-16">
                  See how our tailored solutions can boost your business. From
                  planning to support.
                </div>
            ...
            <div className="col-xl-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="200">
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                <div className="card-icon">
                  <svg className="icon-40" width="40" height="40" viewBox="0 0 40 40" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_9105_30187)">
                      <path
                        d="M25.5174 10.3985C26.5944 10.3985 27.4705 9.52234 27.4705 8.44539C27.4705 7.36844 26.5944 6.49219 25.5174 6.49219C24.4405 6.49219 23.5643 7.36844 23.5643 8.44539C23.5643 8.88523 23.7105 9.29148 23.9569 9.61836L20.7478 14.1028C20.5563 14.0399 20.352 14.0054 20.1397 14.0054C19.6265 14.0054 19.1591 14.2047 18.8102 14.5295L16.6712 13.3158C16.6998 13.1833 16.7151 13.0459 16.7151 12.9051C16.7151 11.8281 15.8389 10.952 14.762 10.952C13.685 10.952 12.8088 11.8281 12.8088 12.9051C12.8088 13.0459 12.8241 13.1833 12.8527 13.3158L10.7137 14.5295C10.3648 14.2047 9.89742 14.0055 9.38422 14.0055C8.30726 14.0055 7.43109 14.8817 7.43109 15.9587C7.43109 17.0356 8.30726 17.9119 9.38422 17.9119C10.4612 17.9119 11.3373 17.0356 11.3373 15.9587C11.3373 15.8178 11.322 15.6805 11.2935 15.548L13.4325 14.3342C13.7814 14.6591 14.2487 14.8584 14.762 14.8584C15.2752 14.8584 15.7424 14.6591 16.0914 14.3343L18.2304 15.548C18.2019 15.6805 18.1866 15.8179 18.1866 15.9588C18.1866 17.0357 19.0627 17.912 20.1397 17.912C21.2167 17.912 22.0929 17.0357 22.0929 15.9588C22.0929 15.5188 21.9466 15.1125 21.7002 14.7856L24.9093 10.3012C25.1007 10.364 25.3051 10.3985 25.5174 10.3985ZM25.5174 7.66406C25.9482 7.66406 26.2987 8.01453 26.2987 8.44539C26.2987 8.87617 25.9482 9.22664 25.5174 9.22664C25.0866 9.22664 24.7362 8.87617 24.7362 8.44539C24.7361 8.01453 25.0866 7.66406 25.5174 7.66406ZM9.38398 16.7398C8.9532 16.7398 8.60273 16.3894 8.60273 15.9585C8.60273 15.5277 8.9532 15.1772 9.38398 15.1772C9.81476 15.1772 10.1652 15.5277 10.1652 15.9585C10.1652 16.3894 9.81476 16.7398 9.38398 16.7398ZM14.7618 13.6863C14.331 13.6863 13.9805 13.3359 13.9805 12.905C13.9805 12.4742 14.331 12.1238 14.7618 12.1238C15.1926 12.1238 15.543 12.4742 15.543 12.905C15.5431 13.3359 15.1926 13.6863 14.7618 13.6863ZM20.1396 16.7398C19.7088 16.7398 19.3584 16.3894 19.3584 15.9585C19.3584 15.5277 19.7088 15.1772 20.1396 15.1772C20.5705 15.1772 20.9209 15.5277 20.9209 15.9585C20.9209 16.3894 20.5704 16.7398 20.1396 16.7398Z"
                        fill="CurrentColor" />
                      <path
331C34.4134 15.075 34.3626 14.7075 34.1045 14.5123C32.3161 13.1591 29.9056 13.0093 27.9637 14.1305C26.6768 14.8735 25.7562 16.0732 25.3716 17.5085C24.987 18.9438 25.1845 20.443 25.9274 21.7299C26.6704 23.0168 27.8701 23.9373 29.3054 24.322C29.7847 24.4504 30.2711 24.5139 30.7543 24.5139C31.7182 24.5139 32.6697 24.2611 33.5268 23.7662C34.743 23.0642 35.6419 21.9395 36.058 20.5992Z"
                        fill="CurrentColor" />
                    </g>
                    <defs>
                      <clipPath id="clip0_9105_30187">
                        <rect width="40" height="40" fill="CurrentColor" />
                      </clipPath>
                    </defs>
                  </svg>
              ...
              <Link className="multicolumn-card" href="service-details.html" aria-label="View Service Details">
                <div className="card-icon">
                  <svg className="icon-40" width="40" height="40" viewBox="0 0 40 40" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M36.7475 14.4384L32.5695 13.132C32.3478 12.4405 32.0681 11.7659 31.735 11.1194L33.7667 7.24062C33.8856 7.01359 33.8432 6.73563 33.662 6.55438L30.6041 3.49734C30.4228 3.31617 30.1448 3.27383 29.9179 3.39273L26.0401 5.4243C25.396 5.09211 24.7214 4.8125 24.0273 4.59L22.7209 0.411094C22.6445 0.166484 22.418 0 22.1617 0H17.8383C17.582 0 17.3555 0.166484 17.2791 0.411094L15.9727 4.59C15.2785 4.8125 14.6039 5.09211 13.9599 5.4243L13.4984 5.18258C13.2116 5.03234 12.8577 5.14313 12.7075 5.42969C12.5574 5.71633 12.668 6.07047 12.9546 6.22062L13.6898 6.60578C13.8634 6.69672 14.0709 6.69492 14.2429 6.60078C14.9885 6.19289 15.7834 5.86344 16.6052 5.62148C16.7929 5.56625 16.9406 5.42094 16.999 5.23422L18.2691 1.17188H21.7309L23.0009 5.23422C23.0593 5.42094 23.207 5.56625 23.3947 5.62148C24.2166 5.86344 25.0114 6.19289 25.757 6.60078C25.929 6.69484 26.1364 6.6968 26.3102 6.60578L30.0802 4.63062L32.5288 7.07852L30.5537 10.8492C30.4628 11.0227 30.4645 11.2301 30.5584 11.4019C30.9679 12.1517 31.2974 12.9466 31.5379 13.7645C31.5931 13.9522 31.7384 14.1 31.9252 14.1584L35.9867 15.4283V18.8895L31.9252 20.1594C31.7384 20.2178 31.5931 20.3655 31.5379 20.5532C31.297 21.372 30.9674 22.167 30.5584 22.9159C30.4646 23.0878 30.4628 23.2952 30.5537 23.4686L32.5288 27.2393L30.0802 29.6872L26.3102 27.712C26.1366 27.6211 25.9291 27.623 25.7571 27.717C25.3564 27.9361 24.939 28.1335 24.5116 28.3063L22.6804 25.6151C24.3072 25.0969 25.7712 24.109 26.8649 22.7742C28.1595 21.1942 28.8726 19.1998 28.8726 17.1584C28.8726 15.4947 28.4074 13.872 27.527 12.4655C27.3552 12.1912 26.9938 12.108 26.7195 12.2798C26.4452 12.4515 26.362 12.813 26.5337 13.0873C27.2971 14.307 27.7007 15.
689 37.8452 10.7131 37.4078 10.9539 37.0538L19.0609 25.1391C19.2759 24.8234 19.6181 24.6423 20 24.6423C20.3819 24.6423 20.7241 24.8234 20.939 25.139L26.3413 33.0788C26.5234 33.3462 26.8879 33.4158 27.1554 33.2336C27.423 33.0516 27.4923 32.6871 27.3102 32.4195L25.1841 29.2948C25.4745 29.1708 25.7608 29.0375 26.04 28.8937L29.9179 30.9253C30.0039 30.9703 30.0971 30.9923 30.1897 30.9922C30.3415 30.9922 30.4915 30.9332 30.6041 30.8206L33.662 27.7636C33.8433 27.5823 33.8857 27.3044 33.7668 27.0773L31.7351 23.1986C32.0678 22.5527 32.3475 21.878 32.5695 21.1859L36.7476 19.8795C36.9922 19.803 37.1587 19.5766 37.1587 19.3203V14.9977C37.1586 14.7414 36.9921 14.5149 36.7475 14.4384Z"
                      fill="CurrentColor" />
                    <path
                      d="M20 12.1562C17.24 12.1562 14.9946 14.4016 14.9946 17.1616C14.9946 19.9216 17.24 22.167 20 22.167C22.76 22.167 25.0054 19.9216 25.0054 17.1616C25.0054 14.4016 22.76 12.1562 20 12.1562ZM20 20.9952C17.8862 20.9952 16.1665 19.2755 16.1665 17.1616C16.1665 15.0478 17.8863 13.3281 20 13.3281C22.1138 13.3281 23.8335 15.0478 23.8335 17.1616C23.8335 19.2755 22.1138 20.9952 20 20.9952Z"
                      fill="CurrentColor" />
                    <path
                      d="M20 37.4259C20.3269 37.4259 20.5919 37.1609 20.5919 36.8341C20.5919 36.5072 20.3269 36.2422 20 36.2422C19.6731 36.2422 19.4081 36.5072 19.4081 36.8341C19.4081 37.1609 19.6731 37.4259 20 37.4259Z"
                      fill="CurrentColor" />
                    <path
                      d="M20 35.0311C20.3237 35.0311 20.5859 34.7687 20.5859 34.4452V27.5859C20.5859 27.2623 20.3237 27 20 27C19.6763 27 19.4141 27.2623 19.4141 27.5859V34.4452C19.4141 34.7687 19.6763 35.0311 20 35.0311Z"
                      fill="CurrentColor" />
                  </svg>
                </div>
                <h2 className="heading text-28">Risk Management</h2>
                <div className="text text-16">
                  See how our tailored solutions can boost your business. From
                  planning to support.
                </div>
        ...
        <div className="section-headings text-center">
          <div className="buttons" data-aos="fade-up">
            <Link href="services.html" className="button button--primary" aria-label="More Services">
              More Services
              <span className="svg-wrapper">
                <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container-fluid">
        <div className="text-banner-inner radius18">
          <div className="section-headings">
            ...
            <div className="buttons" data-aos="fade-up">
              <Link href="services.html" className="button button--secondary" aria-label="See More Services">
                Learn More
                <span className="svg-wrapper">
                  <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="visually-hidden">To learn more about the service, click this button.</span>
              </Link>
            </div>
          </div>
        </div>
    ...
    {/* Text Image */}
    <div className="text-image-sticky mt-100">
      <div className="container">
        <div className="section-headings section-headings-horizontal align-items-start overflow-hidden">
          <div className="section-headings-left">
            <h2 className="heading text-50" data-aos="fade-right">
              Explore the Recent Works We Have Done!
            </h2>
          </div>
          <div className="section-headings-right text text-18" data-aos="fade-left">
        ...
        <div className="section-content">
          <div className="image-text-card radius18">
            <div className="row align-items-center product-grid">
              <div className="col-lg-6 col-12">
                <div className="content section-headings">
                  <div className="subheading text-20 subheading-bg" data-aos="fade-up">
                  ...
                  <h2 className="heading text-50" data-aos="fade-up">
                    Innovation meets business needs
                  </h2>
                  <div className="text text-18" data-aos="fade-up">
                    Our mission is to empowers businesses off all size to
                    thrive in an our businesses ever changing marketplace.
                  </div>
                  <div className="buttons" data-aos="fade-up">
                    <Link href="project.html" className="button button--primary" aria-label="More About Us">
                      Learn More
                      <span className="svg-wrapper">
                        <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span className="visually-hidden">To learn more about the service, click this
                        button.</span>
                    </Link>
                  </div>
                </div>
            ...
            <div className="row align-items-center product-grid">
              <div className="col-lg-6 col-12">
                <div className="content section-headings">
                  ...
                  <h2 className="heading text-50" data-aos="fade-up">
                    Protecting business from uncertainty
                  </h2>
                  <div className="text text-18" data-aos="fade-up">
                    Our mission is to empowers businesses off all size to
                    thrive in an our businesses ever changing marketplace.
          ...
          <div className="swiper">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="card-testimonial radius18" data-aos="fade-up" data-aos-delay="10">
                  <ul className="rating-list list-unstyled">
                    <li className="rating-icon">
                      <svg className="icon icon-24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <div className="user-info-wrap">
                    ...
                    <div className="icon-quote">
                      <svg className="icon icon-62" width="62" height="62" viewBox="0 0 62 62" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
              ...
              <div className="swiper-slide">
                <div className="card-testimonial radius18" data-aos="fade-up" data-aos-delay="150">
                  <ul className="rating-list list-unstyled">
                    <li className="rating-icon">
                      <svg className="icon icon-24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="swiper-slide">
                <div className="card-testimonial radius18" data-aos="fade-up" data-aos-delay="300">
                  <ul className="rating-list list-unstyled">
                    <li className="rating-icon">
                      <svg className="icon icon-24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="featured-blog blog-style-3 mt-100 section-padding">
      <div className="container">
        ...
        <div className="section-content">
            ...
            <div className="col-12 col-md-6 col-lg-4" data-aos="fade-up">
              <div className="card-blog-list" data-aos="fade-up">
                ...
                <h2 className="card-blog-heading heading text-22">
                  <Link href="blog-details.html" className="heading text-22">
          ...
          <div className="buttons buttons-discover" data-aos="fade-up" data-aos-delay="100">
            <Link href="blog.html" className="button button--primary" aria-label="Discover more blog posts">
              Discover More
              <span className="svg-wrapper">
                <svg className="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="contact-form-wrap radius18">
                ...
                <form action="#" className="form contact-form" data-aos="fade-up">
                  <div className="field">
                    ...
                    <input id="ContactForm-name" className="text text-16" type="text" placeholder="Your Name *" name="name"
                      required />
                  </div>
                  <div className="field">
                    ...
                    <input id="ContactForm-email" className="text text-16" type="text" placeholder="Email Here *"
                      name="email" required />
                  </div>
                  <div className="field">
                    ...
                    <input id="ContactForm-service" className="text text-16" type="text" placeholder="Service Type *"
                  ...
                  <div className="field">
                    ...
                    <textarea id="ContactForm-body" className="text text-16" rows="4" placeholder="Your Comment *"
